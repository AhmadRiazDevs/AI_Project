...
def setTime():
    ...
    print("Detecting vehicles for", directionNumbers[(currentGreen+1)%noOfSignals])
...
class Main:
    ...
    background = pygame.image.load(str(BASE_DIR / 'images' / 'mod_int.png'))

    screen = pygame.display.set_mode(screenSize)
    pygame.display.set_caption("SIMULATION")

    # Loading signal images and font
    redSignal = pygame.image.load(str(BASE_DIR / 'images' / 'signals' / 'red.png'))
    yellowSignal = pygame.image.load(str(BASE_DIR / 'images' / 'signals' / 'yellow.png'))
    greenSignal = pygame.image.load(str(BASE_DIR / 'images' / 'signals' / 'green.png'))
